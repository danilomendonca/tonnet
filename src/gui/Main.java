...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButtonAnel = new javax.swing.JToggleButton();
        ...
        jToggleButtonAnel.setText("Anel");
        jToggleButtonAnel.setMaximumSize(new java.awt.Dimension(57, 33));
        jToggleButtonAnel.setMinimumSize(new java.awt.Dimension(57, 33));
        jToggleButtonAnel.setPreferredSize(new java.awt.Dimension(57, 33));
        jToggleButtonAnel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jToggleButtonAnelActionPerformed(evt);
            }
        });
        jToggleButtonAnel.setBounds(10, 10, 119, 23);
        jLayeredPane1.add(jToggleButtonAnel, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jPanelResultadosLayout.setHorizontalGroup(
            ...
            .add(jPanelResultadosLayout.createSequentialGroup()
                ...
                .add(76, 76, 76)
                .add(jToggleButtonTab, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                .add(35, 35, 35)
                .add(jBLimparHistorico)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jBMaximizar)
                .add(109, 109, 109)
                .add(jToggleButtonGraf, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
                .add(52, 52, 52))
...
// 
    ...
    private void jToggleButtonAnelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonAnelActionPerformed

        mPanelDesenho.Reset();
        showPropriedades(((JToggleButton)evt.getSource()).getText());

    }//GEN-LAST:event_jToggleButtonAnelActionPerformed
     ...
     *@param no NoGrf
     */
    public void showPropriedades(final String nomeTopologia) {
        this.pTopologia = new PropriedadesTopologia(nomeTopologia);
        this.pTopologia.addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowClosed(java.awt.event.WindowEvent evt) {
                formWindowClosedPropriedadesTopologia(evt, nomeTopologia);
            }
    ...
    private void formWindowClosedPropriedadesTopologia(java.awt.event.WindowEvent evt, String nomeTopologia) {

        Modelator modelador = null;
        if(nomeTopologia.equals("Anel"))
            modelador = new RingModel(mPanelDesenho.getWidth()/2, mPanelDesenho.getHeight()/2, (int)(0.9 * mPanelDesenho.getHeight()/2), 1);
            
        List [] bothNodesAndLinks = modelador.populate();
        mPanelDesenho.getTopologiaListaNo().addAll(bothNodesAndLinks[1]);
        mPanelDesenho.updateNsquares();
        mPanelDesenho.getTopologiaListaEnl().addAll(bothNodesAndLinks[2]);
        mPanelDesenho.repaint();
    ...
    private javax.swing.JToggleButton jToggleButtonAnel;
